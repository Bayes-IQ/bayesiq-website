...
const PAGES = [
  ...
  { name: "sample-report", path: "/consulting/sample-report" },
  { name: "contact", path: "/contact" },
  { name: "assessment", path: "/assessment" },
  { name: "case-studies", path: "/case-studies" },
  { name: "case-study-detail", path: "/case-studies/analytics-pipeline-migration" },
  { name: "golden-flows-fintech", path: "/consulting/explore/fintech-gf" },
