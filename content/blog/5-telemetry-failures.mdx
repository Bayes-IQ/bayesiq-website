{/* Frontmatter contract (resolved from src/lib/blog.ts / PR#15):
    Required: title, date, description
    Slug: derived from filename → "5-telemetry-failures"
    Route: /blog/5-telemetry-failures
    GFM tables: supported (used in existing posts)
    Internal routes confirmed live: /contact, /services
*/}
---
